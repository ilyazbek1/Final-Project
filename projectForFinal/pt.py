...
closeButton = tk.Button(Frame1, bg="#FFD700", text="Close the Tab", padx=50, pady=5, command=closeButton_callback)
...
blueButton = tk.Radiobutton(Frame3, bg="#006495", text="Blue Filter", font=("ariel 10 bold"), width=45, value=2, command=blueButton_callback)
blueButton.grid(row=0,column=0)

pinkButton = tk.Radiobutton(Frame3, bg="#EE1289", text="Pink Filter", font=("ariel 10 bold"), width=45, value=3, command=pinkButton_callback)
pinkButton.grid(row=0,column=2)

orangeButton = tk.Radiobutton(Frame3, bg="#FF7D40", text="Orange Filter", font=("ariel 10 bold"), width=45, value=4, command=orangeButton_callback)
orangeButton.grid(row=0,column=3)

noneButton = tk.Radiobutton(Frame3, bg="#474747", fg="white", text="None", width=45, font=("ariel 10 bold"), value=5, command=noneButton_callback)
